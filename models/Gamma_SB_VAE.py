...
from variational_coders.encoders import StickBreakingEncoder_Gamma_VAE
from variational_coders.decoders import Decoder

### Gamma VAE ###
class Gamma_SB_VAE(object):
    def __init__(self, rng, input, batch_size, layer_sizes,
        ...
        # init encoder
        self.encoder = StickBreakingEncoder_Gamma_VAE(rng, input=next_layer_input, batch_size=batch_size, in_size=layer_sizes[-1], latent_size=latent_size, W_a = None, W_b = None, epsilon = 0.01)
