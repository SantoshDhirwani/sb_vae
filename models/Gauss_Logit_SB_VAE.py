...
from variational_coders.encoders import StickBreakingEncoder_Logit
from variational_coders.decoders import Decoder

### Gauss_Logit_SB_VAE VAE ###
class Gauss_Logit_SB_VAE(object):
    def __init__(self, rng, input, batch_size, layer_sizes,
        ...
        # init encoder
        self.encoder = StickBreakingEncoder_Logit(rng, input=next_layer_input, batch_size=batch_size, in_size=layer_sizes[-1], latent_size=latent_size, W_mu = None, W_sigma = None, epsilon = 0.01)
