...
def train_and_eval_gaussian_vae(
    ...
    results_file_name = pjoin(experiment_dir, "gauss_vae_results_.txt")
    ...
    for epoch_counter in range(n_epochs):
        ...
        if valid_error < best_valid_error:
            ...
            cPickle.dump(best_params, open(pjoin(experiment_dir, 'gauss_vae_params_.pkl'), 'wb'), protocol=cPickle.HIGHEST_PROTOCOL)
