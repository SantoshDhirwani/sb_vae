...
def train_and_eval_stickBreaking_ss_dgm(
    ...
    results_file_name = pjoin(experiment_dir, "sb_ss-dgm_results_1%labels.txt")
    ...
    for epoch_counter in range(n_epochs):
        ...
        if valid_error < best_valid_error:
            ...
            cPickle.dump(best_params, open(pjoin(experiment_dir, 'sb_ss-dgm_params_1%labels.pkl'), 'wb'), protocol=cPickle.HIGHEST_PROTOCOL)
