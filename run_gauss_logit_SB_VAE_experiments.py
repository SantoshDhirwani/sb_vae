...
from train_scripts.train_Gauss_Logit_SB_VAE import train_and_eval_gauss_logit_SB_VAE
from utils.utils import mkdirs

def build_argparser():
    DESCRIPTION = ("Train a Gauss-Logit StickBreaking Variational Autoencoder using Theano.")
...
if __name__ == '__main__':
    ...
    train_and_eval_gauss_logit_SB_VAE(
        dataset=dataset,
